...
void __not_in_flash_func(core1_entry)()
{
    ...
    volatile uint8_t *byte_from_6502 = &sram[0x0280];              // byte to from 6502 to serial interface
    volatile uint8_t *byte_from_6502_status = &sram[0x0281];       // status of byte from 6502. 1 = there is a byte ready to read. clear it when read
    volatile uint8_t *byte_to_6502 = &sram[0x0282];                // place byte here to 6502. 0 = no data, all else is data
